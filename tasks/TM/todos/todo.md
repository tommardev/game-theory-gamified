...
*Goal: Have a running Next.js app with our design system tokens configured.*
...
*Goal: Define the schema and get the state management working without worrying about final polish.*
...
*Goal: Build the reusable visual blocks that make the app feel gamified and premium.*
...
*Goal: Wire everything together into a playable flow.*
