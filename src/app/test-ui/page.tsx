...
export default function TestUIPage() {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
      ...
      <section>
        ...
        <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            <Button variant="rational" onClick={() => setRationalScore(s => s + 10)}>+10 Rational</Button>
            <Button variant="human" onClick={() => setHumanScore(s => s + 10)}>+10 Human</Button>
            <Button variant="secondary" onClick={() => { setRationalScore(50); setHumanScore(50); }}>Reset</Button>
          </div>
        </div>
      </section>
    </div>
